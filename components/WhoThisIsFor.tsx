...
import { ShieldCheck, Cog, Building2, ClipboardCheck, Wrench } from 'lucide-react';

const roles = [
    { icon: <ShieldCheck size={28} />, title: "Safety Engineers", color: "text-emerald-500", bg: "bg-emerald-100 dark:bg-emerald-500/20" },
    { icon: <Cog size={28} />, title: "Reliability Engineers", color: "text-blue-500", bg: "bg-blue-100 dark:bg-blue-500/20" },
    { icon: <Building2 size={28} />, title: "Plant Managers", color: "text-violet-500", bg: "bg-violet-100 dark:bg-violet-500/20" },
    { icon: <ClipboardCheck size={28} />, title: "Quality Teams", color: "text-amber-500", bg: "bg-amber-100 dark:bg-amber-500/20" },
    { icon: <Wrench size={28} />, title: "Maintenance Leaders", color: "text-rose-500", bg: "bg-rose-100 dark:bg-rose-500/20" },
];
        ...
        <section className="py-16">
            ...
            >
                ...
                <p className="text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
                    Designed for the people who are responsible for turning incidents into lasting improvements.
                </p>
            </motion.div>
