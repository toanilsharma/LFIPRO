            ...
            <main className="container mx-auto px-4 py-16 lg:py-24">
                ...
                <div className="max-w-2xl mx-auto bg-gray-50 p-10 rounded-2xl shadow-lg border border-gray-200">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-6">
                        For any questions, feedback, bug reports, or support inquiries regarding the LFILab tool, please feel free to reach out to us. We are committed to providing a high-quality experience and appreciate your input.
                    </p>
